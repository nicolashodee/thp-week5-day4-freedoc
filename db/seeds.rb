...
50.times do
  doctor = Doctor.new(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, speciality: Faker::Superhero.name , zip_code: Faker::Code.npi, city: City.all.sample)
  doctor.save
